# NOTE: This script is currently NOT in use.
# Archived for reference. Do not delete unless permanently dropping current data usage.
import argparse
import logging
import os
import dask
...
if __name__ == '__main__':
    print("This script is archived and should not be run.")
    exit()
